...
preview: /images/previews/configuration-utility.jpg
layout: admin
icon: bi-gear
...
<div class="tab-content pt-4" id="configTabContent">
  ...
  <div class="tab-pane fade" id="pane-raw" role="tabpanel">
    ...
    <pre class="bg-dark text-light p-3 rounded" style="max-height:600px;overflow:auto;font-size:.8rem"><code id="cfg-raw-yaml">Raw YAML display requires a server-side API or manual copy.
Use the "Open in GitHub" link below to view the full _config.yml.</code></pre>
  </div>
