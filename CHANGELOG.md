...
### Added
- **New ERP post: "ERP customizations should be the default"** (`pages/_posts/erp/2026-09-13-erp-customizations-should-be-the-default.md`) — AI agents and Grok Bots flip the old customization fight; governed extensions should be the default. Preview path reserved pending generation.
